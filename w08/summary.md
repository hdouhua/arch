...
* [数据结构与算法](#数据结构与算法)
    ...
    * [基本数据结构](#基本数据结构)
      ...
      * [树](#树)
          ...
          * [红黑树 RBT](#红黑树-rbt)
          * [红黑树 vs 平衡二叉树](#红黑树-vs-平衡二叉树)
      * [跳表（跳跃列表 skip list）](#跳表跳跃列表-skip-list)
    * [常用算法](#常用算法)
    * [背包问题](#背包问题)
      * [贪心算法](#贪心算法)
      * [动态规划算法解决背包问题](#动态规划算法解决背包问题)
      * [遗传算法解决背包问题](#遗传算法解决背包问题)
* [网络与数据库](#网络与数据库)
    * [网络通信协议](#网络通信协议)
    * [非阻塞网络IO](#非阻塞网络io)
      * [阻塞I/O BIO blocking I/O](#阻塞io-bio-blocking-io)
      * [非阻塞I/O non-blocking I/O](#非阻塞io-non-blocking-io)
      * [Java NIO （new I/O）](#java-nio-new-io)
      * [系统I/O复用方式：select，poll，epoll](#系统io复用方式selectpollepoll)
    * [数据库架构原理与性能优化](#数据库架构原理与性能优化)
      * [数据库架构](#数据库架构)
      * [连接器](#连接器)
      * [语法分析器](#语法分析器)
      * [语义分析与优化器](#语义分析与优化器)
